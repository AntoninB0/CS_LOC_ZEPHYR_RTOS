...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_MAX_CONN_EVENT_LEN_DEFAULT, 3750);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CONN_EVENT_EXTEND_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CENTRAL_ACL_EVENT_SPACING_DEFAULT, 20000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_COUNT, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_EVENT_LEN_DEFAULT, 8500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_SDC_CS_BOARD_DISTANCE_OFFSET, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SCAN_CONNECTABLE_CACHE_SIZE, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RREQ, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RREQ_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RREQ_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_RREQ_MAX_ACTIVE_CONN, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_MAX_ANTENNA_PATHS, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RAS_MODE_3_SUPPORTED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CHANNEL_SOUNDING_REASSEMBLY_BUFFER_SIZE, 4800);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PSA_NEED_CRACEN_ECDH, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CHANNEL_SOUNDING_REASSEMBLY_BUFFER_CNT, 2);
